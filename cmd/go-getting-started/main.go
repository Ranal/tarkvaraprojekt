...
func dbFunc(c *gin.Context) {
	...
	_, err := db.Exec(
		"CREATE TABLE IF NOT EXISTS andmed(eesnimi varchar(50), perekonnanimi varchar(50), email varchar(50), telefon integer); CREATE TABLE IF NOT EXISTS sooduskoodid(kood varchar(50), soodustus float)",)
	if err != nil {
	 log.Fatal(err)
	}
